...
from path_planning_msgs.msg import Edge, Edges, Point2D, Vertex
...
class SampleingBasedPathPlanner(object):
    ...
    def __init__(self):
        ...
        self.sub_tree = rospy.Subscriber("/path_planing/rrt_family/tree", Edges, self.RRTFamilyViz.parser_tree_v2)
